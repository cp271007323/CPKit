Pod::Spec.new do |s|
 ...
 "CPKit/CPNetManager" , "CPKit/CPNetManager/*.{h.m}" ,
 "CPKit/CPNetManager/CPNetRequest" , "CPKit/CPNetManager/CPNetRequest/*.{h.m}" ,
 "CPKit/Base" , "CPKit/Base/*.{h.m}" ,
 "CPKit/CPKitManager" , "CPKit/CPKitManager/*.{h.m}" ,
"CPKit/Views" ,"CPKit/Views/*.{h.m}", "CPKit/Views/CPFileTool", "CPKit/Views/CPFileTool/*.{h.m}" , "CPKit/Views/CPCoverView", "CPKit/Views/CPCoverView/*.{h.m}" , "CPKit/Views/CPAlertController", "CPKit/Views/CPAlertController/*.{h.m}" , "CPKit/Views/CPUserDefaultTool", "CPKit/Views/CPUserDefaultTool/*.{h.m}", "CPKit/Views/CPRefresh", "CPKit/Views/CPRefresh/*.{h.m}" , "CPKit/Views/CPShareController", "CPKit/Views/CPShareController/*.{h.m}" , "CPKit/Views/CPLayoutBtn", "CPKit/Views/CPLayoutBtn/*.{h.m}" ,
